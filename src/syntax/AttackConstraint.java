...
public class AttackConstraint {
     ...
     */
    public AttackConstraint(Argument arg) {
        this.argument = arg;
     ...
     * @param arg some argument
     * @param example some input labeling
     */
    public AttackConstraint(Argument arg, Example example) {
        this.argument = arg;
     ...
     */
    public AttackConstraint(AttackConstraint condition1, AttackConstraint condition2) {
     ...
     */
    public AttackConstraint(AttackConstraint condition1, AttackConstraint condition2, boolean toDNF) {
     ...
     * @param arg some argument
     * @param example some input labeling
     * @return the condition for arg considering example as a conflict-free labeling
     */
    protected AssociativePlFormula getConditionForArgumentCF(Argument arg, Example example) {
     ...
     * @param arg some argument
     * @param example some input labeling
     * @return the condition for arg considering example as an admissible labeling
     */
    protected AssociativePlFormula getConditionForArgumentADM(Argument arg, Example example) {
        AssociativePlFormula formula = new Conjunction();
        switch (example.get(arg)) {
            case IN:
     ...
     * @param arg some argument
     * @param example some input labeling
     * @return the condition for arg considering example as a complete labeling
     */
    protected AssociativePlFormula getConditionForArgumentCO(Argument arg, Example example) {
        AssociativePlFormula formula = new Conjunction();
        switch (example.get(arg)) {
            case IN:
                // an IN argument can not be attacked by another IN argument or a UNDECIDED argument (i.e. then it would not be defended)
     ...
     * @param arg some argument
     * @param example some input labeling
     * @return the condition for arg considering example as a stable labeling
     */
    protected AssociativePlFormula getConditionForArgumentST(Argument arg, Example example) {
